...
type SheetContentProps = ComponentPropsWithoutRef<typeof Dialog.Content> & VariantProps<typeof sheetVariants>
...
const SheetTitle = forwardRef<ElementRef<typeof Dialog.Title>, ComponentPropsWithoutRef<typeof Dialog.Title>>(
  ({ className, ...props }, ref) => {
    return <Dialog.Title ref={ref} className={cn('text-lg font-semibold text-foreground', className)} {...props} />
  }
)
